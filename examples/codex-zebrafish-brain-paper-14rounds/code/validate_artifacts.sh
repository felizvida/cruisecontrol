...
test -f "$PAPER_DIR/main_round28.pdf"
test -f "$PAPER_DIR/main_round29.pdf"
test -f "$PAPER_DIR/main_round31.pdf"
test -f "$PAPER_DIR/main_round32.pdf"
test -f "$PAPER_DIR/main_round33.pdf"
test -f "$PAPER_DIR/main_round34.pdf"
test -f "$PAPER_DIR/main_round36.pdf"
test -f "$PAPER_DIR/main_round38.pdf"
...
test -f "$ROOT/review/round27_review.md"
test -f "$ROOT/review/round30_review.md"
test -f "$ROOT/review/round35_review.md"
test -f "$ROOT/review/round37_review.md"
...
test -f "$ROOT/results/gene_symbol_sensitivity.csv"
test -f "$ROOT/results/presence_overlap_significance.csv"
test -f "$ROOT/results/occupancy_detectability_model.csv"
test -f "$ROOT/results/detectability_stratified_sensitivity.csv"
test -f "$ROOT/results/misidentification_sensitivity.csv"
test -f "$ROOT/results/mnar_similarity_sensitivity.csv"
test -f "$ROOT/results/acetylation_covariate_sensitivity.csv"
test -f "$ROOT/results/motor_family_breakdown.csv"
test -f "$ROOT/results/independent_panel_marker_bias.csv"
test -f "$ROOT/code/environment_versions.json"
test -f "$ROOT/code/reproduce_tables_and_figures.ipynb"
