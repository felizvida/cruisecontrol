...
The manuscript is intentionally honest about scope. It is written as a perspective paper and does not claim newly executed experiments. For that reason, the executable code in this package covers figure generation, paper building, and artifact validation rather than model training.
