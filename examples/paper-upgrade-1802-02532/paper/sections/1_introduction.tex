...
This upgraded paper makes four concrete contributions.
\begin{enumerate}[leftmargin=1.4em]
  \item We reinterpret \citet{corcoran2018spatial} as an early precursor to modern serialized structural learning.
  \item We provide an executable context-budget probe that measures how different serializations expose local mixed-channel neighborhoods to bounded-context sequence processing.
...
The paper is intentionally scoped as a hybrid interface paper. It combines a perspective-style reinterpretation with a small executable study. It does not present a real biomolecular benchmark and should not be read as claiming universal superiority for any single serialization strategy. The contribution is instead to sharpen, and partially operationalize, the design question that the 2018 paper raised before the field had a vocabulary for it.
