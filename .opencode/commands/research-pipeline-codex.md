---
description: Run the end-to-end research pipeline using the pure Codex route.
---
...
Force workflow route: `codex`.
Auto-proceed through checkpoints unless the user explicitly asked to approve each stage.
Keep every artifact, checkpoint, and summary in the current local repository.
